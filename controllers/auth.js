...
const login = async (req, res = response) => {
  try {
    ...
    const usuarioDB = await Usuario.findOne({ correo }).populate([
      {
        path: "rol",
        populate: {
          path: "modulos",
      ...
      {
        path: "sedes", // Nombre del campo que deseas popular (sedes)
        model: "Sede", // Nombre del modelo de sedes
      }
    ]);
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    ...
                    <p>Recientemente solicitaste el cambio de la contraseña para el acceso a tu cuenta en el Sistema</p>
